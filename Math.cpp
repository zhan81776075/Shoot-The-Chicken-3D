...
Math::VECTOR3 Math::Vec3_Cross(const VECTOR3& vec1, const VECTOR3& vec2)
{
	return VECTOR3(
...
Math::VECTOR3 Math::Vec3_Reflect(const VECTOR3 & vec, const VECTOR3 & axis)
{
	VECTOR3 In = vec;
...
inline Math::MATRIX4x4 Math::Matrix_Multiply(const MATRIX4x4& leftMat, const MATRIX4x4& rightMat)
{
	MATRIX4x4 outMat;
	for (UINT i = 0;i < 4;++i)
	{
...
inline Math::VECTOR4	Math::Matrix_Multiply(const MATRIX4x4 leftMat, const VECTOR4& rightColumnVec)
{
	VECTOR4 outVec;
...
Math::MATRIX4x4	Math::Matrix_Translation(float dx, float dy, float dz)
{
...
Math::MATRIX4x4	Math::Matrix_RotationX(float angle)
{
...
Math::MATRIX4x4	Math::Matrix_RotationY(float angle)
{
	//prepared for column vector...
	MATRIX4x4 outMatrix;
...
Math::MATRIX4x4	Math::Matrix_RotationZ(float angle)
{
	//prepared for column vector...
	MATRIX4x4 outMatrix;
...
Math::MATRIX4x4	Math::Matrix_YawPitchRoll(float yaw_Y, float pitch_X, float roll_Z)
{
...
Math::MATRIX4x4 Math::Matrix_PerspectiveProjection(float ViewAngleY, float aspectRatio, float NearPlaneZ, float FarPlaneZ)
{
...
inline Math::MATRIX4x4 Math::Matrix_Transpose(const MATRIX4x4& inMatrix)
{
...
inline Math::VECTOR2 Math::Clamp(const VECTOR2 & val, const VECTOR2 & min, const VECTOR2 & max)
{
	return VECTOR2(Clamp(val.x,min.x,max.x),Clamp(val.y,min.y,max.y));
}

inline Math::VECTOR3 Math::Clamp(const VECTOR3 & val, const VECTOR3 & min, const VECTOR3 & max)
{
...
inline Math::VECTOR2 Math::Lerp(const VECTOR2& start, const VECTOR2& end, float t)
{
	return VECTOR2(Lerp(start.x,end.x,t),Lerp(start.y,end.y,t));
}

inline Math::VECTOR3 Math::Lerp(const VECTOR3& start, const VECTOR3& end, float t)
{
